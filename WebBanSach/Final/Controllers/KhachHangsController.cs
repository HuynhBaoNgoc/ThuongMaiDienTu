...
namespace Final.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKH,TenKH,DiaChi,SDT,UserName,Password,MaQuyen")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKH,TenKH,DiaChi,SDT,UserName,Password,MaQuyen")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
